(() => {
    ...
    (() => {
        ...
        function helpers_getElement(selector) {
            return document.querySelector(selector);
        }
        function helpers_getElements(selector) {
            return document.querySelectorAll(selector);
        }
        const elements_header = document.querySelector("header");
        document.querySelector("footer");
        const modal = helpers_getElement(".modal");
        const modalBody = modal.querySelector(".modal__body");
        function modalsEvents_modalsEvents(target) {
            if (target.dataset.target == "addons") {
                renderProductsModal(target);
                helpers_getElements(".modal-addons__item").forEach((item => {
        ...
        function renderBusinessPlanModal() {
            modalBody.innerHTML = `\n       <div class="modal-business-plan">\n                 <form class="form form-business"  data-form="Отримати бізнес план">\n                                <h2>Eröffnen Sie noch heute Ihr KAVA!!</h2>\n                                <div class="form__subtitle ">Werden Sie mit einem Klick Partner! Bitte füllen Sie das Formular aus, und unsere Manager werden sich mit Ihnen in Verbindung setzen."</div>\n                                <div class="form__items">\n                                    <div class="form__item">\n                                        <input type="text" id="name" name="name">\n                                        <label for="name">Name</label>\n                                        <div class="form__message"></div>\n                                    </div>\n                                    <div class="form__item">\n                                        <input type="text" id="phone" name="phone">\n                                        <label class="none" for="phone">Number</label>\n                                        <div class="form__message"></div>\n                                    </div>\n                                    <button class="btn"><span>VERSENDEN</span></button>\n                                </div>\n                            </form>\n            </div>\n          `;
        }
        function renderFormAnswer(target) {
            modal.classList.add("modal__form-answer");
            modalBody.classList.add("form-answer", "flex", "--just-center", "--align-center", "text-center");
            let title, subtitle;
            if (target.dataset.form == "success") {
                title = "Danke!";
                subtitle = `Unsere Manager werden sich mit Ihnen in Verbindung setzen</br>найближчим часом`;
            } else {
                title = "Hoppla...!";
                subtitle = "Ein Fehler ist aufgetreten! Versuchen Sie es später!";
            }
            modalBody.innerHTML = `\n           <div>\n            <h2 class="text-uppercase">${title}</h2>\n            <h3 class="f-weight--500">${subtitle}</h3>\n            <div class="decor  pos-a">\n            <span></span><span></span><span></span>\n</div>\n\n</div>\n            `;
        }
        class modal_Modal {
        ...
        const modules_modal = modal_Modal;
        let validRegex = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
        const content = {
            field: {
                en: "This field is required",
                ua: "Das Feld ist Pflichtfeld"
            },
            template: {
                en: "Fill in according to the template",
                ua: "Gemäß der Vorlage ausfüllen"
            },
            send: {
                en: "Send",
                ua: "Schicken"
            ...
            name: {
                en: "Enter the name:",
                ua: `Geben Sie einen Namen ein`
            },
            email: {
                en: "Fill in according to the template: test@tect.com",
                ua: `Ausfüllen gemäß der Vorlage: test@tect.com`
            },
            thankTitle: {
                en: "Дякуємо, ми зв'яжемося з Вами найближчим часом!",
                ua: "Vielen Dank, wir werden uns bald bei Ihnen melden!"
            }
        };
        let maskOptions = {
            mask: "+49 (000) 000 - 00 - 00",
            lazy: false
        };
        class Form {
            constructor(form) {
            ...
            checkInputs() {
                this.inputs.forEach((input => {
                    if (input.name === "name") this.checkNameInput(input);
            ...
            resetForm(btn) {
                ...
                this.inputs.forEach((input => {
                    ...
                    input.value = "";
                    if (input.name == "phone") this.mask.updateValue();
                }));
                this.checkInputs();
            }
            checkEmailInput(input) {
                ...
                input.addEventListener("input", (() => {
                    ...
                    if (!isValid) input.nextElementSibling.nextElementSibling.innerHTML = `${email}`; else input.nextElementSibling.nextElementSibling.innerText = "";
                }));
            }
            checkPhoneInput(input) {
                ...
                input.addEventListener("input", (() => {
                    ...
                    if (!isValid) input.nextElementSibling.nextElementSibling.innerHTML = `${template}`; else input.nextElementSibling.nextElementSibling.innerText = "";
                }));
            }
            valid(input) {
            ...
            validateEmptyField() {
                ...
                let isValid = true;
                if (this.form.dataset.formQuestion) if (!this.textarea.value.trim()) {
                    let field = ua;
                    this.textarea.nextElementSibling.innerHTML = `${field}`;
                ...
                let field = ua;
                this.inputs.forEach((input => {
                    if (input.name === "name") if (!input.value.trim()) {
                        input.parentNode.classList.add("invalid");
                        input.nextElementSibling.nextElementSibling.innerHTML = `${field}`;
                        return isValid = false;
                    } else {
                        this.valid(input);
                    ...
                    if (input.name === "phone") if (input.value.indexOf("_") === -1) {
                        this.valid(input);
                        input.nextElementSibling.nextElementSibling.innerText = "";
            ...
            async postData(url, data, btn) {
                try {
                    ...
                    if (response.ok) {
                        ...
                        modalsEvents_modalsEvents(btn);
                        new modules_modal(".modal__form-answer").openModal();
                        this.resetForm(btn);
                    }
                } catch (error) {
            ...
            checkNameInput(input) {
                ...
                input.addEventListener("keypress", (function(e) {
                    if (!e.key.match(/^[a-zA-Zа-щА-ЩЬьЮюЯяЇїІіЄєҐґЁёЭэЪъ\s]/)) e.preventDefault();
                }));
                input.addEventListener("input", (() => {
                    ...
                    if (!isValid) input.nextElementSibling.nextElementSibling.innerHTML = `${name}`; else input.nextElementSibling.nextElementSibling.innerText = "";
                }));
            }
            init() {
                this.checkInputs();
        ...
        const headerNav = elements_header.querySelector(".header__menu");
        const burger = () => {
            if (elements_header) {
                const burger = elements_header.querySelector(".burger");
                if (screen.availWidth <= 1024) elements_header.classList.add("--hide");
        ...
        function toggleMenu(burger) {
            ...
            elements_header.classList.toggle("--hide");
            elements_header.classList.toggle("--show");
            ...
            if (elements_header) {
                ...
                links.forEach((link => {
                    link.addEventListener("click", (function(event) {
                        ...
                        const headerHeight = elements_header.offsetHeight;
                        if (helpers_getElement(".burger").classList.contains("active")) toggleMenu(helpers_getElement(".burger"));
                        window.scrollTo({
        ...
        function sliders() {
            ...
            function reviewsSwiper() {
                if (!helpers_getElement(".reviews-swiper")) return;
                let currentSlide = helpers_getElement(".reviews").querySelector(".counter__current");
                new Swiper(helpers_getElement(".reviews-swiper"), {
                    modules: [ Navigation ],
                    slidesPerView: 3,
                    spaceBetween: 50,
                    preloadImages: false,
                    ...
                    on: {
                        ...
                        beforeInit: function() {
                            ...
                            helpers_getElement(".reviews").querySelector(".counter__total").innerHTML = `${numOfSlides}`;
                        }
                    }
                });
            }
        }
        function renderModalForm_renderModalForm(arr) {
            arr.forEach((item => {
                item.addEventListener("click", (() => {
                    modalsEvents_modalsEvents(item);
                    new modules_modal(".modal").openModal();
                    if (item.dataset.target == "addons") new modules_Form(".modal-addons__form").init();
                    if (item.dataset.target == "business-plan") new modules_Form(".form-business").init();
                }));
            }));
        }
        /*!
 ...
 */
        ...
        function addScrollingClass(i, x) {
            ...
            if (classList.contains(className)) clearTimeout(scrollingClassTimeout[x]); else classList.add(className);
        }
        ...
        EventManager.prototype.unbind = function unbind(element, eventName, handler) {
            ...
            if (ee.isEmpty) this.eventElements.splice(this.eventElements.indexOf(ee), 1);
        };
        ...
        function createEvent(name) {
            if (typeof window.CustomEvent === "function") return new CustomEvent(name); else {
        ...
        function processScrollDiff(i, axis, diff, useScrollingClass, forceFireReachEvent) {
            ...
            var fields;
            if (axis === "top") fields = [ "contentHeight", "containerHeight", "scrollTop", "y", "up", "down" ]; else if (axis === "left") fields = [ "contentWidth", "containerWidth", "scrollLeft", "x", "left", "right" ]; else throw new Error("A proper axis should be provided");
        ...
        function processScrollDiff$1(i, diff, ref, useScrollingClass, forceFireReachEvent) {
            ...
            if (diff) {
                ...
                if (diff < 0) element.dispatchEvent(createEvent("ps-scroll-" + up)); else if (diff > 0) element.dispatchEvent(createEvent("ps-scroll-" + down));
        ...
        function updateGeometry(i) {
            ...
            updateCss(element, i);
            if (i.scrollbarXActive) element.classList.add(cls.state.active("x")); else {
                element.classList.remove(cls.state.active("x"));
                i.scrollbarXWidth = 0;
                i.scrollbarXLeft = 0;
                element.scrollLeft = i.isRtl === true ? i.contentWidth : 0;
            }
            if (i.scrollbarYActive) element.classList.add(cls.state.active("y")); else {
        ...
        function updateCss(element, i) {
            ...
            var roundedScrollTop = Math.floor(element.scrollTop);
            if (i.isRtl) xRailOffset.left = i.negativeScrollAdjustment + element.scrollLeft + i.containerWidth - i.contentWidth; else xRailOffset.left = element.scrollLeft;
        ...
        function bindMouseScrollHandler(i, ref) {
            ...
            function mouseMoveHandler(e) {
                ...
                updateGeometry(i);
                e.stopPropagation();
                if (e.type.startsWith("touch") && e.changedTouches.length > 1) e.preventDefault();
            }
        ...
        function keyboard(i) {
            ...
            i.event.bind(i.ownerDocument, "keydown", (function(e) {
                ...
                if (activeElement) {
                    if (activeElement.tagName === "IFRAME") activeElement = activeElement.contentDocument.activeElement; else while (activeElement.shadowRoot) activeElement = activeElement.shadowRoot.activeElement;
                ...
                switch (e.which) {
                  case 37:
                    if (e.metaKey) deltaX = -i.contentWidth; else if (e.altKey) deltaX = -i.containerWidth; else deltaX = -30;
                    break;

                  case 38:
                    if (e.metaKey) deltaY = i.contentHeight; else if (e.altKey) deltaY = i.containerHeight; else deltaY = 30;
                    break;
                  ...
                  case 32:
                    if (e.shiftKey) deltaY = i.containerHeight; else deltaY = -i.containerHeight;
                    break;
        ...
        function wheel(i) {
            ...
            function shouldPreventDefault(deltaX, deltaY) {
                ...
                var hitsBound;
                if (Math.abs(deltaY) > Math.abs(deltaX)) hitsBound = isTop || isBottom; else hitsBound = isLeft || isRight;
            ...
            function shouldBeConsumedByChild(target, deltaX, deltaY) {
                if (!env.isWebKit && element.querySelector("select:focus")) return true;
                if (!element.contains(target)) return false;
                var cursor = target;
                while (cursor && cursor !== element) {
                    if (cursor.classList.contains(cls.element.consuming)) return true;
                    var style = get(cursor);
                    if (deltaY && style.overflowY.match(/(scroll|auto)/)) {
                        var maxScrollTop = cursor.scrollHeight - cursor.clientHeight;
                        if (maxScrollTop > 0) if (cursor.scrollTop > 0 && deltaY < 0 || cursor.scrollTop < maxScrollTop && deltaY > 0) return true;
                    }
                    if (deltaX && style.overflowX.match(/(scroll|auto)/)) {
                        var maxScrollLeft = cursor.scrollWidth - cursor.clientWidth;
                        if (maxScrollLeft > 0) if (cursor.scrollLeft > 0 && deltaX < 0 || cursor.scrollLeft < maxScrollLeft && deltaX > 0) return true;
                    }
            ...
            function mousewheelHandler(e) {
                ...
                if (!i.settings.useBothWheelAxes) {
                    ...
                    if (deltaY) element.scrollTop -= deltaY * i.settings.wheelSpeed; else element.scrollTop += deltaX * i.settings.wheelSpeed;
                    shouldPrevent = true;
                } else if (i.scrollbarXActive && !i.scrollbarYActive) {
                    if (deltaX) element.scrollLeft += deltaX * i.settings.wheelSpeed; else element.scrollLeft -= deltaY * i.settings.wheelSpeed;
                    shouldPrevent = true;
                }
                updateGeometry(i);
        ...
        function touch(i) {
            if (!env.supportsTouch && !env.supportsIePointer) return;
            var element = i.element;
            function shouldPrevent(deltaX, deltaY) {
                ...
                if (magnitudeY > magnitudeX) {
                    if (deltaY < 0 && scrollTop === i.contentHeight - i.containerHeight || deltaY > 0 && scrollTop === 0) return window.scrollY === 0 && deltaY > 0 && env.isChrome;
                } else if (magnitudeX > magnitudeY) if (deltaX < 0 && scrollLeft === i.contentWidth - i.containerWidth || deltaX > 0 && scrollLeft === 0) return true;
                return true;
            }
            ...
            var easingLoop = null;
            function getTouch(e) {
                if (e.targetTouches) return e.targetTouches[0]; else return e;
            }
            ...
            } else if (env.supportsIePointer) if (window.PointerEvent) {
        ...
        var perfect_scrollbar_esm_PerfectScrollbar = function PerfectScrollbar(element, userSettings) {
            var this$1 = this;
            ...
            if (this.isRtl === true) element.classList.add(cls.rtl);
        ...
        perfect_scrollbar_esm_PerfectScrollbar.prototype.update = function update() {
        ...
        perfect_scrollbar_esm_PerfectScrollbar.prototype.onScroll = function onScroll(e) {
            if (!this.isAlive) return;
            updateGeometry(this);
        ...
        perfect_scrollbar_esm_PerfectScrollbar.prototype.destroy = function destroy() {
            if (!this.isAlive) return;
        ...
        perfect_scrollbar_esm_PerfectScrollbar.prototype.removePsClasses = function removePsClasses() {
            this.element.className = this.element.className.split(" ").filter((function(name) {
                return !name.match(/^ps([-_].+|)$/);
            })).join(" ");
        };
        function willGet() {
            const nav = helpers_getElement('[data-will-get="nav"]');
            if (!nav) return;
            const image = helpers_getElement('[data-will-get="image"]');
            ...
            navBtns.forEach((btn => {
                btn.addEventListener("click", (() => {
                    ...
                    if (index > 1 && index !== 3) removeActive(navBtns, "swiper-button-disabled");
                    switch (index) {
                      case 1:
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            try {
                ...
                headerFixed();
                sliders();
                if (window.outerWidth < 567) willGet();
                scrollToAnchor();
                renderModalForm_renderModalForm(helpers_getElements("[data-target]"));
                if (helpers_getElement(".form")) new modules_Form(".form").init();
                const caps = helpers_getElement("#caps");
                const month = helpers_getElement("#month");
                const cafe = helpers_getElement("#cafe");
                const calculatorResult = helpers_getElement(".calculator__result").querySelector("span");
                helpers_getElements("[data-range]").forEach((rangeItem => {
                    const count = rangeItem.querySelector("[data-range-count]");
                    const min = rangeItem.querySelector("[data-range-min]");
                    const max = rangeItem.querySelector("[data-range-max]");
                    const input = rangeItem.querySelector("input");
                    min.innerText = input.min;
                    max.innerText = input.max;
                ...
                function calculate(caps, month, cafe) {
                    calculatorResult.innerText = Math.round((+caps.value * 990 - +caps.value * 395.7) * +month.value * +cafe.value).toLocaleString().replace(",", " ") + " грн";
                }
            } catch (e) {
                console.log(e);
            }
        ...
        function headerFixed() {
            if (elements_header) window.addEventListener("scroll", (() => {
                try {
                    if (scrollY >= elements_header.clientHeight / 2) elements_header.classList.add("--fixed"); else elements_header.classList.remove("--fixed");
                } catch (e) {
                    console.log(e);
                }
            }));
