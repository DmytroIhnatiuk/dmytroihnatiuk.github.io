(() => {
    ...
    (() => {
        ...
        Swiper.use(modules);
        function slider() {
            if (!helpers_getElement('[data-swiper="slider"]')) return;
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            try {
                ...
                function calculate(caps, month, cafe) {
                    calculatorResult.innerText = Math.round((+caps.value * 990 - +caps.value * 395.7) * +month.value * +cafe.value).toLocaleString().replace(",", " ") + " EUR";
                }
            } catch (e) {
                console.log(e);
            }
